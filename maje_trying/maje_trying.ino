...
if(m==0&&l1==1&&l2==1&&r2==1&&r1==1)
{
 ...
 {
  backward();
  delay(30); //time taken by boat to rotate
 }
 else if((m==0&&l1==0&&l2==0&&r2==1&&r1==1)||(m==0&&l1==1&&l2==0&&r2==1&&r1==0)||(m==1&&l1==1&&l2==1&&r2==0&&r1==1))
 {
    left();
    //delay(2190); // time takn by to turn left such that left wheel is in stop position
 }
 else if(( m==0&&l1==1&&l2==1&&r2==0&&r1==0)||(m==0&&l1==1&&l2==0&&r2==1&&r1==0)||(m==1&&l1==0&&l2==1&&r2==1&&r1==1))
   {
    right();
   ...
   {
    left();
    delay(30); // time takn by to turn left such that left wheel is in stop position
   }*/
